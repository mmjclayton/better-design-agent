...
def main():
    # File paths
    design_intel_v8_path = Path("output/critique-20260404-163701.md")
    design_intel_v7_path = Path("output/critique-20260404-131835.md")
    ...
    files = {
        ...
        "di v7": design_intel_v7_path,
        "di v8": design_intel_v8_path,
